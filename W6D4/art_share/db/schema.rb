...
ActiveRecord::Schema.define(version: 2020_05_14_175429) do
  ...
  create_table "likes", force: :cascade do |t|
    ...
    t.string "liked_media_type", null: false
    t.bigint "liked_media_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["liked_media_type", "liked_media_id"], name: "index_likes_on_liked_media_type_and_liked_media_id"
    t.index ["liker_id", "liked_media_id", "liked_media_type"], name: "index_likes_on_liker_id_and_liked_media_id_and_liked_media_type", unique: true
  end
